...
export default function App() {
  ...
  return (
   ...
   <View style={styles.container}>
      ...
      <Text style={styles.sectionTtile}>Lista de tarefas pendentes</Text>
      </View>
  ...
  {/*task input*/}
    ...
    <TextInput style={styles.input} placeholder={'Informe uma tarefa'} onChangeText ={ text => setTask(text)} value ={task} ></TextInput>
